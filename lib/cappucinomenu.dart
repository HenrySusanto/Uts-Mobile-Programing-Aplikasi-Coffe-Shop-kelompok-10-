...
class CappucinoMenu extends StatefulWidget {
  const CappucinoMenu({Key? key}) : super(key: key);

  @override
  _CappucinoMenuState createState() => _CappucinoMenuState();
}

class _CappucinoMenuState extends State<CappucinoMenu> {
  @override
             ...
             Container(
               ...
               decoration: BoxDecoration(
                   image: DecorationImage(
                     fit: BoxFit.cover,
                     image: AssetImage("images/coffeelatte.jpg"
                     ),
                   ),
